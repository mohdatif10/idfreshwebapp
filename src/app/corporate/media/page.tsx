...
import { AWARDS, PRESS_MENTIONS, SPOTLIGHT_VIDEO, VIDEO_CAMPAIGNS } from "@/data/media";
  ...
  return (
    <div className="py-12 sm:py-16">
      <Container className="max-w-3xl text-center">
        ...
        <p className="mt-4 text-inkgray">{SPOTLIGHT_VIDEO.description}</p>
        <a
          href={SPOTLIGHT_VIDEO.youtubeUrl}
          target="_blank"
          rel="noreferrer"
          className="mt-4 inline-flex items-center gap-1.5 font-heading text-sm font-bold text-brand-600 hover:text-brand-800"
        >
          Watch on YouTube
