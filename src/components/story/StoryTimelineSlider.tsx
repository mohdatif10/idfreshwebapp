...
/**
 * The interactive drag/scroll year-slider timeline — shared by the home page's
 * "Our Story" teaser and the full /corporate/about-us timeline so both give
 * the exact same swipe/drag experience, just with different framing copy
 * around it.
 */
